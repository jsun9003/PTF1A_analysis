...
print
"SampleName\tTotalPairs\tReportedPairs\tRepotedRatio\tValidInteractionPairs\tFF\tRR\tRF\tFR\tLigationEfficiency\tValidRMDUP\tPCRDuplicationRatio\tLongIntraInteraction\tLongIntraRatio\tLibraryEfficiency\n";
foreach my $sample (@samples) {
    ...
    print
"$sample\t$total\t$report\t$report_ratio\t$valid\t$ff\t$rr\t$rf\t$fr\t$ligation_efficiency\t$valid_rmdup\t$pcr_ratio\t$intra\t$intra_ratio\t$library_efficiency\n";
